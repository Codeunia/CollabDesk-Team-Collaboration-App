...
const MessagePage = () => {
    ...
    return (
        <section className='h-[calc(100vh-60px)] w-full overflow-hidden'>
            ...
            <div className='bg-[#21222b] fixed top-0 z-50 px-4 grid grid-cols-[300px_1fr] w-full items-center text-white shadow-md shadow-[#57575765]'>
            ...
            <div className='grid grid-rows-[1fr_55px] h-full'>
